...
public class RegisteredPost {
    ...
    public RegisteredPost(@NotBlank(message = "Sender's name can't be blank") @Pattern(regexp = "[a-z A-Z]{5,20}", message = "Only Alphabets Allowed") String senderName, @NotBlank(message = "Sender's phone number can't be blank") @Pattern(regexp = "[0-9]{5,10}", message = "Only Numbers Allowed") String senderPhoneNumber, @NotBlank(message = "Email can't be blank") @Email(message = "invalid format for email") String sendersEmail, @NotBlank(message = "Sender's address can't be blank") String senderAddress, @NotBlank(message = "Sender's country can't be blank") String senderCountry, @NotBlank(message = "Sender's state can't be blank") String senderState, @NotBlank(message = "Sender's city can't be blank") String senderCity, @NotBlank(message = "Sender's pincode can't be blank") @Pattern(regexp = "[0-9]{6,10}", message = "Only Numbers Allowed") String senderPincode, @NotBlank(message = "Sender's post-weight can't be blank") @Pattern(regexp = "^[1-9][0-9]*", message = "Only Numbers Allowed") String sendersPostWeight, String sendersMoneyPay, @NotBlank(message = "Receiver's name can't be blank") @Pattern(regexp = "[a-z A-Z]{5,20}", message = "Only Alphabets Allowed") String receiverName, @NotBlank(message = "Receiver's phone number can't be blank") @Pattern(regexp = "[0-9]{5,10}", message = "Only Numbers Allowed") String receiverPhoneNumber, @NotBlank(message = "Receiver's address can't be blank") String receiverAddress, @NotBlank(message = "Receiver's country can't be blank") String receiverCountry, @NotBlank(message = "Receiver'sstate can't be blank") String receiverState, @NotBlank(message = "Receiver's city can't be blank") String receiverCity, @NotBlank(message = "Receiver's pincode can't be blank") @Pattern(regexp = "[0-9]{6,10}", message = "Only Numbers Allowed") String receiverPincode, @NotBlank(message = "status") String status) {
